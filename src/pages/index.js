...
const Home = ({ data }) => (
    <Layout>
        ...
        <section className="hero">
            <Image filename="hero.jpg" style={{ height: '100%' }} other={{ loading: 'eager', durationFadeIn: 100 }} />
            <div className="catch">
                <h1>
...
export const query = graphql`
    query {
        allContentfulBlogPost(sort: { fields: publishDate, order: DESC }, skip: 0, limit: 4) {
            edges {
                node {
                    title
                    id
